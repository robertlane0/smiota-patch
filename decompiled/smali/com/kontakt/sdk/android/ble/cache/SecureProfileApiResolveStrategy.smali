.class Lcom/kontakt/sdk/android/ble/cache/SecureProfileApiResolveStrategy;
...
.method constructor <init>(Lcom/kontakt/sdk/android/cloud/KontaktCloud;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lcom/kontakt/sdk/android/ble/cache/SecureProfileApiResolveStrategy;->kontaktCloud:Lcom/kontakt/sdk/android/cloud/KontaktCloud;
...
.method private resolveSecureProfiles(Ljava/util/List;)Ljava/util/List;
    .locals 2
    ...
    .line 1
    iget-object v0, p0, Lcom/kontakt/sdk/android/ble/cache/SecureProfileApiResolveStrategy;->kontaktCloud:Lcom/kontakt/sdk/android/cloud/KontaktCloud;
    ...
    .line 11
    invoke-virtual {v0, p1}, Lcom/kontakt/sdk/android/cloud/api/executor/devices/EddystonesRequestExecutor;->withSecureProfileIds(Ljava/util/List;)Lcom/kontakt/sdk/android/cloud/api/executor/devices/EddystonesRequestExecutor;
    ...
    .line 45
    .line 46
    invoke-virtual {v1}, Lcom/kontakt/sdk/android/common/model/Device;->extractSecureProfileFutureUID()Lcom/kontakt/sdk/android/common/model/SecureProfileFutureUID;
...
.method private secureProfilesToResolve(Ljava/util/Map;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private updateRequests(Ljava/util/Map;Ljava/util/List;)V
    ...
    .line 16
    .line 17
    invoke-direct {p0, p1, v0}, Lcom/kontakt/sdk/android/ble/cache/SecureProfileApiResolveStrategy;->updateRequest(Ljava/util/Map;Lcom/kontakt/sdk/android/common/model/SecureProfileFutureUID;)V
...
.method public resolve(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/kontakt/sdk/android/ble/cache/SecureProfileApiResolveStrategy;->secureProfilesToResolve(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 14
    :cond_0
    invoke-direct {p0, v0}, Lcom/kontakt/sdk/android/ble/cache/SecureProfileApiResolveStrategy;->resolveSecureProfiles(Ljava/util/List;)Ljava/util/List;
    ...
    .line 18
    invoke-direct {p0, p1, v0}, Lcom/kontakt/sdk/android/ble/cache/SecureProfileApiResolveStrategy;->updateRequests(Ljava/util/Map;Ljava/util/List;)V
