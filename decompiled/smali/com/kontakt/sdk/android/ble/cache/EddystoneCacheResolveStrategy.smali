.class Lcom/kontakt/sdk/android/ble/cache/EddystoneCacheResolveStrategy;
...
.method constructor <init>(Lcom/kontakt/sdk/android/ble/cache/FutureShufflesCache;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lcom/kontakt/sdk/android/ble/cache/EddystoneCacheResolveStrategy;->cache:Lcom/kontakt/sdk/android/ble/cache/FutureShufflesCache;
...
.method private resolveEddystones(Ljava/util/List;)Ljava/util/List;
    ...
    .line 21
    .line 22
    iget-object v2, p0, Lcom/kontakt/sdk/android/ble/cache/EddystoneCacheResolveStrategy;->cache:Lcom/kontakt/sdk/android/ble/cache/FutureShufflesCache;

    .line 23
    .line 24
    invoke-virtual {v1}, Lcom/kontakt/sdk/android/common/model/EddystoneUid;->toString()Ljava/lang/String;
    ...
    .line 43
    :cond_1
    new-instance v3, Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;

    .line 44
    .line 45
    invoke-direct {v3}, Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;-><init>()V
    ...
    .line 52
    .line 53
    invoke-virtual {v3, v4}, Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;->futureIds(Ljava/util/List;)Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;
    ...
    .line 61
    invoke-virtual {v3, v4}, Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;->uniqueId(Ljava/lang/String;)Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;
    ...
    .line 65
    invoke-virtual {v3, v1}, Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;->queriedBy(Lcom/kontakt/sdk/android/common/model/EddystoneUid;)Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;
    ...
    .line 69
    invoke-virtual {v2}, Lcom/kontakt/sdk/android/common/model/ResolvedId;->getEddystoneUID()Lcom/kontakt/sdk/android/common/model/EddystoneUid;
    ...
    .line 73
    invoke-virtual {v1, v2}, Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;->resolved(Lcom/kontakt/sdk/android/common/model/EddystoneUid;)Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;
    ...
    .line 77
    invoke-virtual {v1}, Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID$Builder;->build()Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID;
...
.method private updateRequests(Ljava/util/Map;Ljava/util/List;)V
    ...
    .line 16
    .line 17
    invoke-direct {p0, p1, v0}, Lcom/kontakt/sdk/android/ble/cache/EddystoneCacheResolveStrategy;->updateRequest(Ljava/util/Map;Lcom/kontakt/sdk/android/common/model/EddystoneFutureUID;)V
...
.method public resolve(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/kontakt/sdk/android/ble/cache/EddystoneCacheResolveStrategy;->eddystonesToResolve(Ljava/util/Map;)Ljava/util/List;
    ...
    .line 14
    :cond_0
    invoke-direct {p0, v0}, Lcom/kontakt/sdk/android/ble/cache/EddystoneCacheResolveStrategy;->resolveEddystones(Ljava/util/List;)Ljava/util/List;
    ...
    .line 18
    invoke-direct {p0, p1, v0}, Lcom/kontakt/sdk/android/ble/cache/EddystoneCacheResolveStrategy;->updateRequests(Ljava/util/Map;Ljava/util/List;)V
