...
.method public static synthetic a(Lkotlin/sequences/Sequence;)Ljava/util/Spliterator;
    ...
    .line 1
    invoke-static {p0}, Lkotlin/streams/jdk8/StreamsKt;->b(Lkotlin/sequences/Sequence;)Ljava/util/Spliterator;
...
.method public static final asStream(Lkotlin/sequences/Sequence;)Ljava/util/stream/Stream;
    ...
    .line 7
    .line 8
    invoke-direct {v0, p0}, Lm/h;-><init>(Lkotlin/sequences/Sequence;)V
    ...
    .line 14
    invoke-static {v0, p0, v1}, Lm/a;->a(Ljava/util/function/Supplier;IZ)Ljava/util/stream/Stream;
...
.method private static final b(Lkotlin/sequences/Sequence;)Ljava/util/Spliterator;
    .locals 1
    ...
    .line 11
    .line 12
    invoke-static {p0, v0}, Lm/g;->a(Ljava/util/Iterator;I)Ljava/util/Spliterator;
...
.method public static final toList(Ljava/util/stream/DoubleStream;)Ljava/util/List;
    ...
    .line 4
    invoke-static {p0}, Lm/f;->a(Ljava/util/stream/DoubleStream;)[D
...
.method public static final toList(Ljava/util/stream/IntStream;)Ljava/util/List;
    ...
    .line 2
    invoke-static {p0}, Lm/e;->a(Ljava/util/stream/IntStream;)[I
...
.method public static final toList(Ljava/util/stream/LongStream;)Ljava/util/List;
    ...
    .line 3
    invoke-static {p0}, Lm/d;->a(Ljava/util/stream/LongStream;)[J
...
.method public static final toList(Ljava/util/stream/Stream;)Ljava/util/List;
    ...
    .line 1
    invoke-static {}, Lm/b;->a()Ljava/util/stream/Collector;

    move-result-object v0

    invoke-static {p0, v0}, Lm/c;->a(Ljava/util/stream/Stream;Ljava/util/stream/Collector;)Ljava/lang/Object;
